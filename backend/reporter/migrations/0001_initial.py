    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.OneToOneField(db_column='report_id', on_delete=django.db.models.deletion.CASCADE, to='reporter.Report')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hdd_capacity_gb', models.FloatField()),
                ('hdd_usage_gb', models.FloatField()),
                ('computer', models.OneToOneField(db_column='computer_id', null=True, on_delete=django.db.models.deletion.SET_NULL, to='reporter.WatchmanComputer')),
            ],
            options={
                'abstract': False,
            },
